...
from app.schema import Account, Alias, Counselor, Group, UserRole  # noqa: F401
...
# --- CUSTOM LOGIC: LOAD ENVIRONMENT VARIABLES ---
# This allows you to use a .env file locally without checking it into Git
try:
